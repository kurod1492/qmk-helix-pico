...
[_QWERTY] = LAYOUT(
  ...
  [_LOWER] = LAYOUT(
      ...
      KC_LCTL, _______, _______, _______, _______, _______,                     _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
      KC_LSFT, _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, _______,
      _______, _______, KC_LALT, KC_LGUI, EISU,    LOWER,    KC_SPC,   KC_ENT,  RAISE,   KANA,    _______, KC_VOLD, KC_VOLU, _______
      ),
  ...
  [_RAISE] = LAYOUT(
      ...
      _______, _______, KC_LALT, KC_LGUI, EISU,    LOWER,    KC_SPC,   KC_ENT, RAISE,   KANA,    _______, _______, _______, _______
      ),
