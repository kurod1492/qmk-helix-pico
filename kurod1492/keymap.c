...
[_QWERTY] = LAYOUT(
      ...
      ADJUST,  KC_SUU,  KC_LALT, KC_LGUI, KC_ESC,  LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RSFT
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
...
/* SUU */
  [_SUU] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_0,    KC_MINS, KC_EQL,  KC_PLUS, KC_ENT
      )
};
