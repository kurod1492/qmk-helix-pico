...
[_QWERTY] = LAYOUT(
      ...
      KC_ESC,  ADJUST,  EISU,    KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT , RAISE,   KC_RCTL, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
      ),
  ...
  [_LOWER] = LAYOUT(
      ...
      KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_EQL,  KC_UNDS, KC_PLUS, KC_PIPE,
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_EQL,  KC_LCBR, KC_RCBR, KC_END,  _______,
   ...
   */
  [_RAISE] = LAYOUT(
      KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_QUOT,
      KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_UP ,  KC_RGHT, _______, KC_BSLS,
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BRID, KC_BRIU, _______
      ),
