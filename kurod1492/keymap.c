...
[_QWERTY] = LAYOUT(
  ...
  [_LOWER] = LAYOUT(
      ...
      KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS, KC_PLUS, KC_PSCR, KC_HOME, _______,
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  _______, KC_LCBR, KC_RCBR, KC_END,  KC_PIPE,
  ...
  [_RAISE] = LAYOUT(
      ...
      KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_UP ,  KC_RGHT, KC_PLUS, KC_EQL,
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_EQL,  KC_MINS, KC_LBRC, KC_RBRC, KC_PGUP, KC_BSLS,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
      ),
