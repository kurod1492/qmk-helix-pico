...
[_QWERTY] = LAYOUT(
      ...
      ADJUST,  KC_SUU,  KC_LALT, KC_LGUI, KC_ESC,  KC_SPC, LOWER, RAISE, KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_LBRC
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_LOWER] = LAYOUT(
      ...
      KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  _______, KC_PSCR, KC_HOME, KC_END,  KC_RSFT,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, KC_RBRC
      ),
...
/* SUU */
  [_SUU] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, KC_ENT,  KC_0,    KC_MINS, KC_EQL,  KC_PLUS, KC_RSFT
      )
};
