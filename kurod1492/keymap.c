...
[_QWERTY] = LAYOUT(
      ...
      ADJUST,  KC_SUU,  KC_LALT, KC_LGUI, KC_ESC,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
...
/* SUU */
  [_SUU] = LAYOUT(
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_4,    KC_5,    KC_6,    KC_RBRC, KC_BSLS,
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_1,    KC_2,    KC_3,    KC_PGUP, _______,
