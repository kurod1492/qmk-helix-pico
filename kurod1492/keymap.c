...
[_QWERTY] = LAYOUT(
      ...
      KC_ESC,  ADJUST,  EISU,    KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT , RAISE,   KC_MINS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
      ),
  ...
  [_RAISE] = LAYOUT(
      ...
      KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_UP ,  KC_RGHT, KC_EQL,  KC_UNDS,
